...
exports.getUniqueConnectionId = void 0;
exports.reset = reset;
exports.add = add;
...
function onConnect(ws, connectionId) {
        ...
        if (connectionPair.has(connectionId)) {
            ...
            if (pair && pair[0] != null && pair[1] != null) {
                ws.send(JSON.stringify({
                    type: "error",
                    message: "".concat(connectionId, ": This connection id is already used."),
                }));
                return;
            }
    ...
    var payload = {
        ...
        transactionId: (0, uuid_generator_1.uuidGenerator)(),
    };
...
function onDisconnect(ws, connectionId) {
    ...
    if (connectionIds) {
        ...
        if (connectionPair.has(connectionId)) {
            ...
            if (otherSessionWs) {
                otherSessionWs.send(JSON.stringify({ type: "disconnect", connectionId: connectionId }));
                otherSessionWs.close(1000, "Connection ".concat(connectionId, " has been closed by the client"));
            }
            connectionPair.delete(connectionId);
        }
        ws.send(JSON.stringify({ type: "disconnect", connectionId: connectionId }));
        ws.close(1000, "Connection ".concat(connectionId, " has been closed by the client"));
    }
}
