...
var websocketlogs_model_1 = require("./model/websocketlogs.model");
...
var WSSignaling = /** @class */ (function () {
    function WSSignaling(server, mode) {
        ...
        handler.reset(mode);
        this.wss.on("connection", function (ws) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                console.log("msg", msg);
                                dbLogs = new websocketlogs_model_1.default({
                                    transactionId: msg.transactionId,
                                });
                                for (key in msg) {
                                    dbLogs[key] = msg[key];
                                }
                                return [4 /*yield*/, dbLogs.save()];
                            case 1:
                                _a.sent();
                                switch (msg.type) {
                                    case "connect":
