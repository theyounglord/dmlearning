...
describe('http signaling test in public mode', function () {
    ...
    var _a = express_1.getMockRes(), res = _a.res, next = _a.next, mockClear = _a.mockClear;
    var req = express_1.getMockReq({ header: jest.fn(function () { return sessionId; }) });
    var req2 = express_1.getMockReq({ header: jest.fn(function () { return sessionId2; }) });
    var req3 = express_1.getMockReq({ header: jest.fn(function () { return sessionId3; }) });
    beforeAll(function () {
    ...
    test('delete session1', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    req = express_1.getMockReq({ header: jest.fn(function () { return sessionId; }) });
    ...
    test('delete session2', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    req2 = express_1.getMockReq({ header: jest.fn(function () { return sessionId2; }) });
...
describe('http signaling test in private mode', function () {
    ...
    test('response status 400 if connecctionId does not set', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    req3 = express_1.getMockReq({ header: jest.fn(function () { return sessionId; }) });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    body = { connectionId: connectionId };
                    req3 = express_1.getMockReq({ header: jest.fn(function () { return sessionId3; }) });
                    req3.body = body;
                    return [4 /*yield*/, httpHandler.createConnection(req3, res)];
                case 2:
                    _a.sent();
